...
export class EventsService {
   ...
   * @throws ApiError
   */
  public static createEvent(requestBody: CreateEventRequest): CancelablePromise<Event> {
    return __request(OpenAPI, {
      method: 'POST',
      url: '/events',
      body: requestBody,
   ...
   * @throws ApiError
   */
  public static getEvent(eventId: string): CancelablePromise<Event> {
    return __request(OpenAPI, {
      method: 'GET',
      url: '/events/{eventId}',
      path: {
   ...
   * @throws ApiError
   */
  public static startEvent(eventId: string): CancelablePromise<Event> {
    return __request(OpenAPI, {
      method: 'POST',
   ...
   * @throws ApiError
   */
  public static getLeaderboard(eventId: string): CancelablePromise<Array<LeaderboardEntry>> {
    return __request(OpenAPI, {
      method: 'GET',
