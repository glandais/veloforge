...
public class CyclistEntity extends PanacheMongoEntity {
  ...
  public static class CyclistCapabilities {
    ...
    public CyclistCapabilities(
        double pma, double physicalEndurance, double sleepResistance, double mentalResilience) {
      this.pma = pma;
  ...
  public static class CyclistState {
    ...
    public CyclistState(
        double energyReserve, double muscularFatigue, double cerebralFatigue, double hydration) {
